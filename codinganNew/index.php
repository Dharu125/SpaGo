...
<div class="container" style="display:grid;grid-template-columns:1.1fr 1fr;gap:64px;align-items:center">
  ...
  <div><img src="../assets/spa-hero.jpg" alt="Home spa" style="border-radius:18px;box-shadow:0 30px 60px -30px rgba(60,40,20,.3)"></div>
</div>
</body></html>
